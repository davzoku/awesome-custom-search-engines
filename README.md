...
Gmail | gmail | `https://mail.google.com/mail/u/0/#search/%s` | Search through your gmail from omnibar directly!
...
Google Maps | gm | `https://www.google.com/maps/search/%s?hl=en&source=opensearch` |
Google Play | gp | `https://play.google.com/store/search?q=%s&c=apps` |
...
jdsports.co.uk | jd | `https://www.jdsports.co.uk/products/search?q=%s` |
...
NLB | nlb | `http://catalogue.nlb.gov.sg/cgi-bin/spydus.exe/ENQ/EXPNOS/BIBENQ?ENTRY=%s&ENTRY_NAME=BS&ENTRY_TYPE=K&SORTS=SQL_REL_TITLE` |
...
Stackoverflow | st | `https://stackoverflow.com/search?q=%s` |
...
udemy.com | udemy | `https://www.udemy.com/courses/search/?q=%s&src=ukw` |
Urban Dictionary | urbandictionary | `http://www.urbandictionary.com/define.php?term=%s` |
...
5. If it's not there, click "add" and input accordingly
